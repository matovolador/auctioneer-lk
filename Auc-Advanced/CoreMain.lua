--[[
	...
	Revision: $Id: CoreMain.lua 4678 2010-02-27 00:53:37Z Nechckn $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.8/Auc-Advanced/CoreMain.lua $", "$Rev: 4678 $")
